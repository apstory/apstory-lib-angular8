...
import { ApplicationInsights, IPageViewTelemetry, IEventTelemetry, IExceptionTelemetry } from '@microsoft/applicationinsights-web';
import { LoggerSeverityEnum } from './enum/apstory-logger-severity-enum';

@Injectable({
  providedIn: 'root'
})
export class ApstoryLogger8Service {
